...
const HO_NAV: Entry[] = [
  { to: '/head-office', label: 'Dashboard', icon: 'dashboard', module: 'head_office' },
  { to: '/projects', label: 'Projects', icon: 'domain', module: 'projects' },
  { to: '/notices', label: 'Notice Board', icon: 'campaign', module: 'notices' },

  { group: 'Payroll', icon: 'payments', items: [
    { to: '/payroll', label: 'Run Payroll', icon: 'payments', module: 'payroll' },
    { to: '/payroll-setup', label: 'Payroll Setup', icon: 'settings', module: 'payroll' },
    { to: '/payroll-advances', label: 'Overtime, Loans & Advances', icon: 'more_time', module: 'payroll' },
    { to: '/payroll-reports', label: 'Payroll Reports', icon: 'assessment', module: 'payroll' },
  ] },

  { group: 'People', icon: 'badge', items: [
    { to: '/employees', label: 'Employees', icon: 'badge', module: 'employees' },
    { to: '/labour-dashboard', label: 'Labour Dashboard', icon: 'monitoring', module: 'labour' },
    { to: '/team', label: 'Team', icon: 'group_add', module: 'team' },
    { to: '/designations', label: 'Designations', icon: 'work', module: 'designations' },
    { to: '/permissions', label: 'Permissions', icon: 'lock', adminOnly: true },
    { to: '/admin/staff', label: 'Staff & Access', icon: 'admin_panel_settings', adminOnly: true },
  ] },

  { group: 'Vendors', icon: 'store', items: [
    { to: '/vendors', label: 'Vendor Database', icon: 'store', module: 'vendors' },
    { to: '/work-orders', label: 'Work Orders', icon: 'assignment_turned_in', module: 'work_orders' },
    { to: '/vendor-bills', label: 'Vendor Bills', icon: 'request_quote', module: 'vendor_bills' },
    { to: '/vendor-issues', label: 'Issued Items', icon: 'assignment_return', module: 'store' },
    { to: '/vendor-payments', label: 'Payments & Advances', icon: 'payments', module: 'vendor_payments' },
    { to: '/vendor-progress', label: 'Vendor Progress', icon: 'trending_up', module: 'vendor_progress' },
    { to: '/vendor-reports', label: 'Vendor Reports', icon: 'assessment', module: 'vendor_reports' },
    { to: '/vendor-admin', label: 'Vendor Admin', icon: 'admin_panel_settings', adminOnly: true },
  ] },
  ...
  { group: 'Assets', icon: 'precision_manufacturing', items: [
    { to: '/assets', label: 'Company Assets', icon: 'precision_manufacturing', module: 'machines' },
  ] },

  { group: 'Site Operations', icon: 'engineering', items: [
    { to: '/hindrances', label: 'Hindrance Register', icon: 'report', module: 'hindrances' },
    { to: '/eot', label: 'Extension of Time', icon: 'gavel', module: 'eot' },
  ] },

  { group: 'Accounting', icon: 'account_balance', items: [
    { to: '/accounting', label: 'Chart of Accounts', icon: 'account_balance', module: 'accounting' },
    { to: '/give-imprest', label: 'Staff Imprest', icon: 'volunteer_activism', module: 'imprest' },
    { to: '/bank-recon', label: 'Bank Reconciliation', icon: 'account_balance_wallet', module: 'bank_recon' },
    { to: '/credit', label: 'Credit Management', icon: 'credit_score', module: 'credit' },
  ] },

  { group: 'Financial Reports', icon: 'assessment', items: [
    { to: '/finance-reports', label: 'Financial Reports', icon: 'assessment', module: 'finance_reports' },
    { to: '/gst', label: 'GST Reports', icon: 'receipt_long', module: 'gst_reports' },
    { to: '/admin/reports', label: 'Reports & Export', icon: 'download', module: 'reports' },
    { to: '/accounting-export', label: 'Tally / Zoho Export', icon: 'swap_horiz', module: 'accounting_export' },
  ] },

  { group: 'Settings', icon: 'settings', items: [
    { to: '/boq-schedules', label: 'Schedule Master', icon: 'list_alt', module: 'boq_schedules' },
    { to: '/admin/invite', label: 'Invite Code', icon: 'qr_code_2', adminOnly: true },
    { to: '/bugs', label: 'Bug Reports', icon: 'bug_report', module: 'bug_reports' },
  ] },
]
